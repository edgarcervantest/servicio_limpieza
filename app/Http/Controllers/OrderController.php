...
class OrderController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        DB::transaction(function () use ($data) {
            ...
            $folio = Folio::create();
            $folio->update([
                'folio' => 'FOL-' . str_pad($folio->id_folio, 6, '0', STR_PAD_LEFT)
            ]);
            ...
            foreach ($data['colonias'] as $id_colonia => $colonia) {
                ...
                DB::table('orden_colonia')->insert([
                    ...
                    'porcentaje_atendido' => $colonia['porcentaje_atendido'],
                    'habitantes' => $colonia['habitantes'],
                ]);
            }
        });

        return redirect()->back()->with('success', 'Orden guardada correctamente');
    }
